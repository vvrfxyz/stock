...
|---|---|---|---|---|---|
| **residual_vol（特质波动，对市场单因子残差）** | 日线 | IC .018-.042，**全 4 horizon 过 Bonferroni**（t=5.03/3.78/3.53/3.25，2016-2026） | **vol 族首选表达（排序信息）** | 与 low_vol 秩相关 **0.971**=同一因子；机制裁决：波动效应来自**特质波动而非 beta**（EW 中小盘 universe 里 beta 解释不了个股总波动）。变现判决同 low_vol——排序强、超额无 | wave-5 |
