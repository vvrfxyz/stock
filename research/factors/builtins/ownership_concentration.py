...
class OwnershipConcentrationFactor:
    name: ClassVar[str] = "ownership_concentration"
    ...
    def compute(self, ctx: FactorContext) -> pd.DataFrame:
        ...
        return panels["hhi"].reindex(index=ctx.dates, columns=ctx.security_universe)


register(OwnershipConcentrationFactor())
