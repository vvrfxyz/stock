...
用法：
    ...
    python -m research.lowvol_monetization --start 2007-07-02 --end 2015-12-31   # OOS 腿
    （OOS 下限 2007-07：spy 分红因子链 2007-03 起，更早窗口的 spy 总收益不完整，
      脚本内断言会拦截——2026-07 实测 2003 起跑立即触发断言，正是该防线的用途。）
"""
